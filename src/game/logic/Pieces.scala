...
case class Game3x3Square(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 0, anchorP) {
...
case class JBlock(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 1, anchorP) {
}
object JBlock{
...
case class LBlock(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 2, anchorP){
}
object LBlock{
...
case class SBlock(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 3, anchorP) {
}
object SBlock{
...
case class ZBlock(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 4, anchorP){
}
object ZBlock{
...
case class TBlock(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 5, anchorP){
}
object TBlock{
  def apply() : TBlock = new TBlock(List[Point](Point(0, -1), Point(0, 0), Point(-1, 0), Point(1, 0)))
}

case class UBlock(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 6, anchorP){
}
object UBlock{
...
case class OBlock(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 7, anchorP){
}
object OBlock{
...
case class I_Block(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 8, anchorP){
}
object I_Block{
...
case class DotBlock(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 9, anchorP){
}
object DotBlock{
...
case class I2Block(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 10, anchorP){
}
object I2Block{
...
case class I3Block(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 11, anchorP){
}
object I3Block{
...
case class I4Block(blockList: List[Point], anchorP: Point = Point(0, 0)) extends Block(blockList, 12, anchorP){
}
object I4Block{
